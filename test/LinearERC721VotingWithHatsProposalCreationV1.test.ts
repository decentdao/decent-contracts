...
describe('LinearERC721VotingWithHatsProposalCreationV1', () => {
  ...
  async function deployLinearERC721VotingWithHatsProposalCreation(
    ...
    const initializeCalldata = implementation.interface.encodeFunctionData('setUp', [
  ...
  describe('Contract-Specific Functionality', () => {
    ...
    describe('ERC165', function () {
      ...
      beforeEach(async function () {
        ...
        const IERC721VotingStrategyV1Interface = IERC721VotingStrategy__factory.createInterface();
