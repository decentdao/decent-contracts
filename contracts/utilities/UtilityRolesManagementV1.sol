...
contract UtilityRolesManagementV1 is IUtilityRolesManagementV1, DeploymentBlockNonInitializable, ERC165 {
        ...
        onlyDelegatecall
    {
        ...
        IERC6551Executable(recipientHatAccount_).execute(
            sablier_,
            0,
            abi.encodeCall(ISablierLockupBase.withdrawMax, (streamId_, to_)),
            0 // operation type
        );
    }
    ...
    function cancelStream(address sablier_, uint256 streamId_) public virtual override onlyDelegatecall {
        ...
        ISablierLockup(sablier_).cancel(streamId_);
    }
        ...
        for (uint256 i = 0; i < streamParams_.length;) {
            ...
            ISablierLockup(sablierStreamParams.sablier).createWithTimestampsLL(
                Lockup.CreateWithTimestamps({
                    ...
                    token: IERC20(sablierStreamParams.token),
                    ...
                    shape: sablierStreamParams.shape,
                    broker: sablierStreamParams.broker
                }),
                sablierStreamParams.unlockAmounts,
                sablierStreamParams.cliffTime
            );
